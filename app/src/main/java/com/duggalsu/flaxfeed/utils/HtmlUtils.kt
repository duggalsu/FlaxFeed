...
package com.duggalsu.flaxfeed.utils
        ...
        if (!TextUtils.isEmpty(content)) {
            ...
            if (!imagesToDl.isEmpty()) {
                doAsync {
                    ...
                    com.duggalsu.flaxfeed.App.context.startService(Intent(com.duggalsu.flaxfeed.App.context, FetcherService::class.java).setAction(FetcherService.ACTION_DOWNLOAD_IMAGES))
                }
            }
        }

...
import com.duggalsu.flaxfeed.utils.setupTheme
...
class DiscoverActivity : AppCompatActivity(), FeedManagementInterface {
    ...
    override fun addFeed(view: View, title: String, link: String) {
        doAsync {
            ...
            com.duggalsu.flaxfeed.App.db.feedDao().insert(feedToAdd)
            uiThread {
    ...
    override fun deleteFeed(view: View, feed: SearchFeedResult) {
        doAsync {
            com.duggalsu.flaxfeed.App.db.feedDao().deleteByLink(feed.link)
        }
    }

...
import com.duggalsu.flaxfeed.utils.FILE_SCHEME
import com.duggalsu.flaxfeed.utils.HtmlUtils
import com.duggalsu.flaxfeed.utils.UTF8
            ...
            override fun shouldOverrideUrlLoading(view: WebView, url: String): Boolean {
                try {
                    if (url.startsWith(FILE_SCHEME)) {
                        ...
                        val contentUri = getUriForFile(context, "com.duggalsu.flaxfeed.fileprovider", file)
